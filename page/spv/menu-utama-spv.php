...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="#page-top">PACKAGING DEVELOPMENT DEPARTMENT - LOGIN SPV</a>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" aria-current="page" href="menu-utama-spv.html"><strong>HOME</strong></a>
          </li>
          <li class="nav-item">
      ...
      <div class="container overflow-hidden">
        <div class="row gx-5">
          ...
          <div class="col">
            ...
            <a href="../../page/admin/sppbp/form-entry-data-sppbp.php">
              <img src="../../image/entry data sppbp.png" alt="Form Input Data SPPBP" style="width:157px">
            </a>


            <a href="../../page/admin/data-karyawan/list-data-karyawan.php">
